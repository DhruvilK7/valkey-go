module github.com/DhruvilK7/valkey-go/valkeycompatmock
...
replace github.com/DhruvilK7/valkey-go/valkeycompat => ../valkeycompat

require (
	github.com/DhruvilK7/valkey-go v0.0.1-beta.3
	github.com/DhruvilK7/valkey-go/mock v0.0.1-beta.3
	github.com/DhruvilK7/valkey-go/valkeycompat v0.0.1-beta.3
